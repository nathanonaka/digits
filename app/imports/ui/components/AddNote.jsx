...
class AddNote extends React.Component {
  ...
  submit(data) {
    ...
    Notes.insert({ note, owner, contactId, createdAt, owner }, this.insertCallback);
  }
...
AddNote.propTypes = { owner: PropTypes.string.isRequired, contactId: PropTypes.string.isRequired}
