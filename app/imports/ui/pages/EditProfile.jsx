...
class EditProfile extends React.Component {
  ...
  submit(data) {
    const { lastName, firstName, email, picture, bio, fluentLanguages, practiceLanguages, _id } = data;
    Profiles.update(_id, { $set: { lastName, firstName, email, picture, bio, fluentLanguages, practiceLanguages } }, (error) => (error ?
